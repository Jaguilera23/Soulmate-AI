        ...
        <>
            <section className="lg:flex-row flex xs:flex-col justify-around items-center">
                ...
                <div className="flex flex-col order-1">
                    ...
                    <AddToCart text="Add to Cart" imagen="cart" clase="w-[11.375rem] h-[2.5625rem] justify-center text-[0.78931rem] items-center border-subtitlePurple" onAddToCart={() => onAddToCart(selectedCharacter)} />
