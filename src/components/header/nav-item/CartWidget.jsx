const CartWidget =() =>{
    return(
        <button className="flex relative">
            <p className='me-4 text-subtitlePurple'>SHOP CART</p>
            ...
            <div className="w-3 h-3 bg-red-500 border-solid rounded-full  flex justify-center items-center absolute left-[125px] bottom-3">
